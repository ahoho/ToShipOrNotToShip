...
from evaluation.SETTINGS import scenarios, lang_names, investigated_metrics
...
if __name__ == "__main__":
    ...
    if 'SacreBLEU_bleu' in investigated_metrics:
